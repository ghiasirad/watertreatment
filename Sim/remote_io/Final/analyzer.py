...
def updating_writer(a):
    ...
    polution_out = int(data["outputs"]["polution_out"]*65535)
    level_wing_out_1 = int(data["outputs"]["level_wing_out_1"]*65535/4)
    level_wing_out_2 = int(data["outputs"]["level_wing_out_1"]*65535/4)
    print data

    # import pdb; pdb.set_trace()
    context[slave_id].setValues(4, 1, [polution_out,level_wing_out_1,level_wing_out_2])
...
def run_update_server():
    ...
    StartTcpServer(context, identity=identity, address=("192.168.95.35", 502))
